...
--               /home/deos/hu.babin-riby/Documents/Code/TSW_ADC_DAC_PROCESSING/DAC_DEMO/dac_demo_vivado_proj/dac_demo_design.gen/sources_1/bd/design_1/ip/design_1_clk_wiz_0_0_1/design_1_clk_wiz_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_clk_wiz_0_0_clk_wiz is
  signal app_clk_200_design_1_clk_wiz_0_0 : STD_LOGIC;
  signal clk_in1_design_1_clk_wiz_0_0 : STD_LOGIC;
  signal tx_ref_clk_100_design_1_clk_wiz_0_0 : STD_LOGIC;
...
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE"
        ...
        port map (
      CE => '1',
      I => tx_ref_clk_100_design_1_clk_wiz_0_0,
      O => tx_ref_clk_100
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE"
        ...
        port map (
      CE => '1',
      I => app_clk_200_design_1_clk_wiz_0_0,
      O => app_clk_200
    );
mmcme3_adv_inst: unisim.vcomponents.MMCME3_ADV
    generic map(
      ...
      CLKOUT0 => tx_ref_clk_100_design_1_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcme3_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => app_clk_200_design_1_clk_wiz_0_0,
...
inst: entity work.design_1_clk_wiz_0_0_clk_wiz
     port map (
      app_clk_200 => app_clk_200,
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      locked => locked,
      reset => reset,
      tx_ref_clk_100 => tx_ref_clk_100
    );
end STRUCTURE;
