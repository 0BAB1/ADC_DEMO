...
#
# Script generated by Vivado on Tue Oct 14 17:33:23 CEST 2025
# SW Build 6140274 on Wed May 21 22:58:25 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : high_speed_selectio_wiz_0.sh
...
#
# Usage        : high_speed_selectio_wiz_0.sh
#                high_speed_selectio_wiz_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                high_speed_selectio_wiz_0.sh [-reset_run]
#                high_speed_selectio_wiz_0.sh [-reset_log]
#                high_speed_selectio_wiz_0.sh [-help]
#
...
#                script (type 'high_speed_selectio_wiz_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname high_speed_selectio_wiz_v3_6_11 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm high_speed_selectio_wiz_v3_6_11 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "high_speed_selectio_wiz_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./high_speed_selectio_wiz_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work high_speed_selectio_wiz_v3_6_11 $xmvlog_opts +incdir+"../../../../../../../../../../../../tools/Xilinx/2025.1/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.high_speed_selectio_wiz_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.high_speed_selectio_wiz_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/deos/hu.babin-riby/Documents/Code/TSW_ADC_DAC_PROCESSING/DAC_DEMO/high_speed_selectio_wiz_0_ex/high_speed_selectio_wiz_0_ex.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log high_speed_selectio_wiz_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./high_speed_selectio_wiz_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: high_speed_selectio_wiz_0.sh [-help]\n\
Usage: high_speed_selectio_wiz_0.sh [-step]\n\
Usage: high_speed_selectio_wiz_0.sh [-lib_map_path]\n\
Usage: high_speed_selectio_wiz_0.sh [-reset_run]\n\
Usage: high_speed_selectio_wiz_0.sh [-reset_log]\n\
Usage: high_speed_selectio_wiz_0.sh [-keep_index]\n\
Usage: high_speed_selectio_wiz_0.sh [-noclean_files]\n\n\
