...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/deos/hu.babin-riby/Documents/Code/TSW_ADC_DAC_PROCESSING/DAC_DEMO/high_speed_selectio_wiz_0_ex/high_speed_selectio_wiz_0_ex.cache/compile_simlib/questa"
  fi
