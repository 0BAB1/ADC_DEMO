...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L high_speed_selectio_wiz_v3_6_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot high_speed_selectio_wiz_0 xil_defaultlib.high_speed_selectio_wiz_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim high_speed_selectio_wiz_0 -key {Behavioral:sim_1:Functional:high_speed_selectio_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f60c.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb high_speed_selectio_wiz_0.wdb xsim.dir libdpi.so)
