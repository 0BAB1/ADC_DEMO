...
design_libs=(xpm high_speed_selectio_wiz_v3_6_11 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work high_speed_selectio_wiz_v3_6_11 $vlogan_opts +v2k +incdir+"../../../../../../../../../../../../tools/Xilinx/2025.1/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.high_speed_selectio_wiz_0 xil_defaultlib.glbl -o high_speed_selectio_wiz_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./high_speed_selectio_wiz_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/deos/hu.babin-riby/Documents/Code/TSW_ADC_DAC_PROCESSING/DAC_DEMO/high_speed_selectio_wiz_0_ex/high_speed_selectio_wiz_0_ex.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key high_speed_selectio_wiz_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc high_speed_selectio_wiz_0_simv.daidir vcs_lib c.obj)
